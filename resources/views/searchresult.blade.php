...
<script src="{{ asset('/js/sortresult.js') }}"></script>
  ...
  <table class="container-fluid p-5 text-center m-0" id="glossar">
    ...
    <tr>
      <td><div id="ranking">{{$collection['Ranking']}}</div></td>
      <td>Dummy Game ABC</td>
      <td><div id="release">{{$collection['ReleaseDate']}}</div></td>
      <td><div id="platform">{{$collection['Platform']}}</div></td>
    </tr>
    <tr>
      <td><div id="ranking">{{$collection['Ranking']}}</div></td>
      <td>Dummy Game XYZ</td>
      <td><div id="release">{{$collection['ReleaseDate']}}</div></td>
      <td><div id="platform">{{$collection['Platform']}}</div></td>
    </tr>
...
<div class="footer2"><br><b>Found entries: XX | Total Database entries: YY</b>
